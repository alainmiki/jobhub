...
import { initCandidateRouter } from './routes/candidate.js';
import { initEmployerRouter } from './routes/employer.js';
...
app.use('/candidate', initCandidateRouter(auth));
app.use('/employer', initEmployerRouter(auth));
